<footer class="wide-tb-70 bg-sky-blue pb-0">
          ...
          <div class="blog-list-footer">
            <ul class="list-unstyled">
              <li>
                <div class="media">
                  <div class="post-thumb">
                     <img src="{{ url('assets/images/post_thumb_1.jpg') }}" alt="" class="rounded-circle">
                  </div>
              ...
              <li>
                <div class="media">
                  <div class="post-thumb">
                     <img src="{{ url('assets/images/post_thumb_2.jpg') }}" alt="" class="rounded-circle">
                  </div>
                  <div class="media-body post-text">
    ...
    <div class="copyright-wrap bg-kavya-blue wide-tb-30">
      <div class="container">
        <div class="row text-md-left text-center">
            ...
            <div class="col-sm-12 col-md-6 text-md-right text-center">
                  Designed by <a href="#" rel="nofollow">Greefi Technologies</a> © 2019 All Rights Reserved
            </div>
        </div>
      </div>
    </div>
                ...
                <div class="col-md-7 col-12">
                    <div class="px-3 m-5">
                      ...
                      <form action="#" method="post" novalidate="novalidate" class="rounded-field">
                          ...
                          <div class="form-row">
                            <div class="col">
                              <div class="center-head"><span class="bg-light-gray txt-kavya-blue">Your Personal Details</span></div>
                            </div>
                          </div>
                          <div class="form-row mb-4">
                            <div class="col">
                          ...
                          <div class="form-row">
                            <div class="col pt-3">
                              <button type="submit" class="form-btn btn-theme bg-kavya-blue">Send Message <i class="icofont-rounded-right"></i></button>
                            </div>
                          </div>
                      </form>        
                    </div>  
